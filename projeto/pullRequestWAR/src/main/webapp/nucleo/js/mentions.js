...
function carregarConclusoesMentions(componentId,codigoTipoExame){
	...
	$(".mention").mentionsInput({
	    ...
	    onDataRequest:function (mode, query, callback) {
	      ...
	      $.getJSON('/ilaudos-webapp/mentions/data.json?codigoTipoExame='+codigoTipoExame, function(responseData) {
